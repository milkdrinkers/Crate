<div align="center">
  ...
  _**Crate** is a file management library that allows for easy creation and use of [YAML](https://yaml.org/), [JSON](https://www.json.org/) & [TOML](https://toml.io/) files. The library is maintained with three goals in mind: stability, performance and utility._
