...
import com.github.milkdrinkers.crate.internal.serialize.CrateSerializer;
import com.github.milkdrinkers.crate.util.ClassWrapper;
...
public interface DataStorage {
    ...
    /**
     * Method to deserialize a class using the {@link CrateSerializer}. You will need to register
     * your serializable in the {@link CrateSerializer} before.
     *
     * @param key   The key your value should be associated with.
     * @param value The value you want to set in your data-structure.
     */
    default <T> void setSerializable(@NonNull final String key, @NonNull final T value) {
        try {
            final Object data = CrateSerializer.serialize(value);
            set(key, data);
     ...
     * @param def Default value {@literal &} type of it
     */
    ...
    /**
     * Method to serialize a Class using the {@link CrateSerializer}. You will need to register
     * your serializable in the {@link CrateSerializer} before.
     *
    ...
    default <T> T getSerializable(final String key, final Class<T> clazz) {
        ...
        return CrateSerializer.deserialize(raw, clazz, key);
    }
    ...
    default <T> List<T> getSerializableList(final String key, final Class<T> type) {
        ...
        return rawList
            .stream()
            .map(input -> CrateSerializer.deserialize(input, type, key))
    ...
    /**
     * Mix of setDefault {@literal &} getDefault.
